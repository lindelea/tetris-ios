...
class GameScene: SKScene {
    ...
    let LayerPosition = CGPoint(x: 10, y: -50)
    ...
    override init(size: CGSize) {
        ...
        background.size = CGSize(width: 812.0, height: 734.0)
        ...
        let gameBoard = SKSpriteNode(texture: gameBoardTexture, size: CGSize(width: BlockSize * CGFloat(NumOfColumns), height: BlockSize * CGFloat(NumOfRows)))
